$(document).ready(function() {
   ...
   function formatState (state) {
	...
	$(".select2-show-search-make").select2({
	  placeholder: sl2_make,
	  width: '100%'
	});
	$(".select2-show-search-model").select2({
	  placeholder: sl2_model,
	  width: '100%'
	});
	$(".select2-show-search-yf").select2({
	  placeholder: sl2_year_from,
	  width: '100%'
	});
	$(".select2-show-search-yt").select2({
	  placeholder: sl2_year_to,
	  width: '100%'
	});
